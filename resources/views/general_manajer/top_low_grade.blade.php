                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
                        <div>
                            <h1 class="text-2xl font-bold text-slate-800 flex items-center gap-2">
                                ...
                                Top & Low Grade Performance
                            </h1>
                            <p class="text-slate-500 mt-1">Monitoring kinerja manager dan divisi</p>
                        </div>
                        
                        <div class="bg-white rounded-lg shadow-sm p-4 w-full lg:w-auto">
                            <form method="GET" action="{{ route('general_manajer.top_low_grade') }}" class="flex flex-wrap gap-3 items-end">
                                <div>
                                    <label class="block text-xs font-medium text-slate-500 mb-1">Bulan</label>
                                    <select name="bulan" class="border border-slate-200 rounded-lg px-3 py-2 text-sm bg-white">
                                        @for($i=1; $i<=12; $i++)
                                ...
                                <div>
                                    ...
                                    <select name="tahun" class="border border-slate-200 rounded-lg px-3 py-2 text-sm bg-white">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('general_manajer.top_low_grade') }}" class="px-4 py-2 bg-slate-200 text-slate-700 rounded-lg text-sm ml-2 hover:bg-slate-300 transition">
                        ...
                        <div class="stat-card bg-white rounded-xl p-5 border border-slate-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-slate-800">{{ $statistik['total_manager'] ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="stat-card bg-white rounded-xl p-5 border border-slate-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-slate-800">{{ $statistik['total_divisi'] ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="stat-card bg-white rounded-xl p-5 border border-slate-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-slate-800">{{ number_format($statistik['rata_rata_manager'] ?? 0, 1) }}%</p>
                                </div>
                            </div>
                        </div>
                        <div class="stat-card bg-white rounded-xl p-5 border border-slate-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-slate-800">{{ number_format($statistik['rata_rata_divisi'] ?? 0, 1) }}%</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden">
                            <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-4">
                                <h3 class="text-white font-bold text-lg flex items-center gap-2">
                                    <i class="fa-solid fa-trophy text-amber-300"></i> TOP 5 MANAGER
                                </h3>
                                    ...
                                    <tbody class="divide-y divide-slate-100">
                                        @forelse($topManagers as $index => $m)
                                            <tr class="hover:bg-slate-50">
                                                <td class="px-4 py-3">
                                                    <span class="inline-flex w-8 h-8 rounded-full items-center justify-center text-xs font-bold text-white 
                        ...
                        <div class="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden">
                            <div class="bg-gradient-to-r from-rose-600 to-rose-700 px-6 py-4">
                                <h3 class="text-white font-bold text-lg flex items-center gap-2">
                                    <i class="fa-solid fa-triangle-exclamation text-rose-300"></i> LOW 5 MANAGER
                                </h3>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden">
                            <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-4">
                                <h3 class="text-white font-bold text-lg flex items-center gap-2">
                                    <i class="fa-solid fa-trophy text-amber-300"></i> TOP 5 DIVISI
                                </h3>
                        ...
                        <div class="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden">
                            <div class="bg-gradient-to-r from-rose-600 to-rose-700 px-6 py-4">
                                <h3 class="text-white font-bold text-lg flex items-center gap-2">
                                    <i class="fa-solid fa-triangle-exclamation text-rose-300"></i> LOW 5 DIVISI
                                </h3>
