...
<head>
    ...
    <title>Data Perusahaan - General Manager</title>
...
<body class="font-display bg-background-light text-text-light">
    <div class="flex min-h-screen">
        ...
        @php
            ...
            // This prevents "Undefined variable" errors if controller doesn't pass it.
                                        ...
                                        @if($perusahaans->count() > 0)
                                            ...
                                            @foreach($perusahaans as $perusahaan)
                                                <tr class="perusahaan-row" 
                                                    ...
                                                    <td style="min-width: 150px;">
                                                        <!-- Tampilan Angka Murni (Sesuai Request) -->
    ...
    <div id="tambahPerusahaanModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                ...
                <!-- Route diupdate ke general_manajer.perusahaan.store -->
                <form action="{{ route('general_manajer.perusahaan.store') }}" method="POST" id="tambahPerusahaanForm" class="space-y-4" enctype="multipart/form-data">
                    @csrf
                        <div>
                    ...
                    <div class="mt-4">
                        ...
                        <!-- Ganti ke Type Number, Tanpa Rupiah -->
                        <input type="number" name="jumlah_kerjasama" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="0" step="1">
                    </div>
    ...
    <div id="editPerusahaanModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                ...
                <!-- Route diupdate ke general_manajer.perusahaan.update -->
                <form method="POST" action="{{ route('general_manajer.perusahaan.update', '') }}" id="editPerusahaanForm" class="space-y-4" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Jumlah Kerjasama</label>
                            <!-- Ganti ke Type Number, Tanpa Rupiah -->
                            <input type="number" id="editJumlahKerjasama" name="jumlah_kerjasama" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="0" step="1">
                        </div>
                    </div>
                    <div class="flex justify-end gap-2 mt-6">
    ...
    <div id="deleteModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-md">
            <div class="p-6">
                ...
                <!-- Route diupdate ke general_manajer.perusahaan.delete -->
                <form id="deleteForm" method="POST" action="{{ route('general_manajer.perusahaan.delete', '') }}">
                    @csrf
                    @method('DELETE')
                    <div class="mb-6">
    ...
    <script>
        ...
        document.querySelectorAll('.edit-btn').forEach(button => {
            button.addEventListener('click', () => {
                ...
                // SET ACTION URL DINAMIS (Updated to general_manajer)
                editPerusahaanForm.action = `/general_manajer/perusahaan/${button.dataset.id}`;
        ...
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', () => {
                ...
                // Set action form delete (Updated to general_manajer)
                document.getElementById('deleteForm').action = `/general_manajer/perusahaan/${id}`;
        ...
        editPerusahaanForm.addEventListener('submit', function(e) {
            ...
            // URL diupdate ke /general_manajer/perusahaan/{id}
            fetch(`/general_manajer/perusahaan/${id}`, {
                method: 'POST',
                body: formData,
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
