    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 flex flex-col main-content">
            <div class="flex-grow p-3 sm:p-8">
                <!-- Header Form -->
                <div class="mb-6">
                    <h2 class="text-xl sm:text-3xl font-bold mb-2">Edit Surat Kerjasama</h2>
                    <p class="text-text-muted-light">Perbarui detail surat kerjasama yang sudah ada.</p>
                </div>

                <form method="POST" action="{{ route('admin.surat_kerjasama.update', $surat->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="panel-body">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="para_pihak" name="para_pihak" class="hidden">{!! old('para_pihak', $surat->para_pihak) !!}</textarea>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="maksud_tujuan" name="maksud_tujuan" class="hidden">{!! old('maksud_tujuan', $surat->maksud_tujuan) !!}</textarea>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="ruang_lingkup" name="ruang_lingkup" class="hidden">{!! old('ruang_lingkup', $surat->ruang_lingkup) !!}</textarea>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="jangka_waktu" name="jangka_waktu" class="hidden">{!! old('jangka_waktu', $surat->jangka_waktu) !!}</textarea>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="biaya_pembayaran" name="biaya_pembayaran" class="hidden">{!! old('biaya_pembayaran', $surat->biaya_pembayaran) !!}</textarea>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="kerahasiaan" name="kerahasiaan" class="hidden">{!! old('kerahasiaan', $surat->kerahasiaan) !!}</textarea>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="penyelesaian_sengketa" name="penyelesaian_sengketa" class="hidden">{!! old('penyelesaian_sengketa', $surat->penyelesaian_sengketa) !!}</textarea>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <textarea id="penutup" name="penutup" class="hidden">{!! old('penutup', $surat->penutup) !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            @if($surat->tanda_tangan)
                                <div class="mb-4 p-3 bg-gray-50 border border-gray-200 rounded inline-block">
                                    ...
                                    <img src="{{ $surat->tanda_tangan }}" class="w-48 h-auto">
                                </div>
                            @endif

                            <p class="text-sm text-text-muted-light mb-4">Buat tanda tangan baru di bawah ini (jika ingin mengganti):</p>
